          ...
          <div>
            ...
            <div className="mt-8 space-y-3">
              {[
                ...
                { icon: Phone, label: 'Phone', value: '+91 81244 72943 / +91 90031 19026', sub: 'Mon–Sat, 10am–8pm IST' },
                { icon: MapPin, label: 'Studio', value: 'Nungambakkam High Road, Chennai', sub: 'By appointment' },
            ...
            <div className="mt-8 overflow-hidden rounded-3xl border border-charcoal-100 shadow-soft">
              <div className="flex items-center gap-3 bg-charcoal-900 p-5 text-white">
                ...
                <div>
                  ...
                  <div className="text-xs text-charcoal-300">Nungambakkam High Road, Chennai</div>
                </div>
              </div>
              <div className="grid h-48 place-items-center bg-charcoal-50 text-sm text-charcoal-400">
                <div className="text-center">
                  ...
                  <p className="mt-2">Map preview · Nungambakkam High Road, Chennai</p>
                </div>
              </div>
            </div>
          </div>
